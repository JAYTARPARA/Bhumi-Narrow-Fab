...
var AddOrdersPageModule = /** @class */ (function () {
    function AddOrdersPageModule() {
    }
...
var AddOrdersPage = /** @class */ (function () {
    ...
    AddOrdersPage.prototype.AccessGallery = function () {
        var _this = this;
        this.camera.getPicture({
    ...
    AddOrdersPage.prototype.addOrder = function () {
        var _this = this;
        var partyname = this.partyname;
        var partymobile = this.partymobile;
        var partyaddress = this.partyaddress;
        ...
        if (partyname == undefined || partymobile == undefined || partyaddress == undefined || quantity == undefined || partyname == '' || partymobile == '' || partyaddress == '' || quantity == '') {
            ...
            fileTransfer.upload(this.base64Image, "https://bhuminarrowfab.000webhostapp.com/mysql.php?callapi=1&process=addOrder&partyname=" + partyname + "&partymobile=" + partymobile + "&partyaddress=" + partyaddress + "&quantity=" + quantity + "&pieces=" + pieces + "&sample=" + sample, options).then(function (result) {
                ...
                if (JSON.parse(JSON.parse(JSON.stringify(result.response)))['success'] == 1) {
                    ...
                    _this.nav.navigateForward('/whatsapp-orders');
                }
                else {
    ...
    AddOrdersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-admin-add-orders-add-orders-module-es5.js.map