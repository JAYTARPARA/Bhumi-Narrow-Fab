...
let AuthenticationService = class AuthenticationService {
    constructor(http, nativeHttp, plt, toastCtrl, socialSharing, alertCtrl) {
        this.http = http;
    ...
    presentToast(message, showbutton, position, duration, color) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    getAllOrders(results, page, searchKey, searchstatus) {
        ...
        if (this.plt.is('cordova')) {
            return new Promise(resolve => {
                // tslint:disable-next-line:max-line-length
                Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(this.nativeHttp.get(`https://bhuminarrowfab.000webhostapp.com/mysql.php?callapi=1&process=getAllOrders&results=${results}&page=${page}&searchKey=${searchKey}&searchstatus=${searchstatus}`, { 'Content-Type': 'application/json' }, {}))
                    .subscribe(data => {
                    resolve(JSON.parse(data.data));
                }, error => {
                    resolve({ success: 2, message: this.serverErrorMsg });
