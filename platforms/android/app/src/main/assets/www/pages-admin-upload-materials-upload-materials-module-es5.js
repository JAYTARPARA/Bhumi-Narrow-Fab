...
var UploadMaterialsPage = /** @class */ (function () {
    function UploadMaterialsPage(auth, nav, platform, camera, transfer, loadingController, menu) {
        this.auth = auth;
        this.nav = nav;
    ...
    UploadMaterialsPage.prototype.upload = function () {
        ...
        if (name == undefined || mid == undefined || color == undefined || price == undefined || mowner == undefined || name == '' || mid == '' || color == '' || price == '' || mowner == '') {
            ...
            // tslint:disable-next-line:max-line-length
            fileTransfer.upload(this.base64Image, "https://bhuminarrowfab.000webhostapp.com/mysql.php?callapi=1&process=uploadMaterial&name=" + name + "&mid=" + mid + "&color=" + color + "&price=" + price + "&mowner=" + mowner, options).then(function (result) {
