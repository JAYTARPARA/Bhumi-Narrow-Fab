...
var AllMaterialsPage = /** @class */ (function () {
    function AllMaterialsPage(fireAuth, router, platform, activatedRoute, auth, toastCtrl, loadingController, alertCtrl, menu, modalController) {
    ...
    AllMaterialsPage.prototype.loadMaterials = function (infiniteScroll) {
        ...
        this.auth.getMaterials(this.results, this.page, this.searchKey, this.owner).then(function (response) {
