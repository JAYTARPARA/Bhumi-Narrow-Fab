...
var AllUsersPage = /** @class */ (function () {
    function AllUsersPage(fireAuth, router, platform, activatedRoute, auth, toastCtrl, loadingController, alertCtrl, callNumber, menu, nativePageTransitions) {
    ...
    AllUsersPage.prototype.ngOnInit = function () {
    ...
    AllUsersPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    AllUsersPage.prototype.loadUsers = function (infiniteScroll) {
        var _this = this;
        if (this.searchKey == undefined) {
            this.searchKey = '';
        }
        this.auth.getUsers(this.results, this.page, this.searchKey).then(function (response) {
    ...
    AllUsersPage.prototype.loadMore = function (infiniteScroll) {
    ...
    AllUsersPage.prototype.wait = function (time) {
    ...
    AllUsersPage.prototype.callMe = function (number) {
    ...
    AllUsersPage.prototype.blockMe = function (mobile, status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var subHeaderMsg, loadMessage, alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                                        ...
                                        handler: function () {
                                            _this.loadingController.create({
                                                ...
                                                res.onDidDismiss().then(function (dis) {
                                                    _this.ionViewWillEnter(1);
                                                });
                                            });
                                            _this.auth.blockUnblockUser(mobile, status).then(function (response) {
                                                _this.loadingController.dismiss();
                                                if (response['success'] == 1) {
                                                    _this.auth.presentToast(response['message'], false, 'bottom', 1000, 'success');
                                                }
                                                else if (response['success'] == 2) {
                                                    _this.auth.presentToast(response['message'], false, 'bottom', 1500, 'danger');
                                                }
                                                else {
                                                    _this.auth.presentToast(response['message'], false, 'bottom', 1500, 'danger');
                                                }
    ...
    AllUsersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-admin-all-users-all-users-module-es5.js.map